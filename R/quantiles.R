...
#' @export
hd.crub <- function(x, q.C = 0.5, q.L = 0.1, q.U = 0.9, L = NULL, U = NULL){
...
#' @export
hd.lts <- function(x, q.C = 0.5, q.L = 0.1){
...
#' @export
hd.uts <- function(x, q.C = 0.5, q.U = 0.9){
...
#' @export
hd.niqr <- function(x, p = 0.25, q.L = 0.1, q.U = 0.9){
...
#'
#' Computes the octile-based kurtosis measure of Moors (1988).
#'
#' @param x Numeric vector.
#' @return Numeric Moors quantile kurtosis.
#' @references Moors, J. J. A. (1988). A quantile alternative for kurtosis.
#' @export
hd.kurt <- function(x){
